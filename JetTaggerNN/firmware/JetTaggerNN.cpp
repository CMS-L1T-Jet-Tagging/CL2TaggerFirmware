...
void JetTaggerNN(
    ...
    #pragma HLS INTERFACE ap_vld port=inputs,layer23_out,layer24_out 
    #pragma HLS DATAFLOW
    ...
    nnet::pointwise_conv_1d_cl<layer2_t, qDense_phi_1_result_t, config28>(layer2_out, layer28_out, w28, b28); // qDense_phi_1
    ...
    nnet::linear<layer22_t, layer23_t, linear_config23>(layer22_out, layer23_out); // qDense_out_reg_linear
