...
typedef ap_fixed<15,12,AP_RND,AP_SAT,0> batchnorm_inputs_default_t;
typedef ap_fixed<16,6> model_default_t;
typedef ap_fixed<30,21> qDense_phi_1_result_t;
...
typedef ap_fixed<10,6,AP_RND,AP_SAT,0> layer22_t;
...
typedef ap_fixed<18,8> qDense_out_reg_linear_table_t;
typedef ap_ufixed<8,0,AP_RND,AP_SAT,0> layer24_t;
