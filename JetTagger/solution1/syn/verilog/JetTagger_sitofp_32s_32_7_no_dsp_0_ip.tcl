...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name JetTagger_sitofp_32s_32_7_no_dsp_0_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name JetTagger_sitofp_32s_32_7_no_dsp_0_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips JetTagger_sitofp_32s_32_7_no_dsp_0_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files JetTagger_sitofp_32s_32_7_no_dsp_0_ip.xci]
generate_target {synthesis simulation} [get_files JetTagger_sitofp_32s_32_7_no_dsp_0_ip.xci]
